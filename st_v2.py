...
# 업데이트 일자 표시
file_path = "assets/PKG3_data.xlsx"
last_update_date = get_file_update_date(file_path)
st.markdown(f"<p style='font-size:0.8em; color:gray;'>업데이트 일자: {last_update_date}</p>", unsafe_allow_html=True)
