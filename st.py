...
st.set_page_config(
    page_title="DSHI HY",
    page_icon="e:/DSHI RPA/STREAMLIT/DSHI_1.jpg",  # 페이지 설정에 로고 추가
    layout="wide"
)

# 사이드바에 로고 추가
st.sidebar.image("e:/DSHI RPA/STREAMLIT/DSHI.jpg", use_container_width=True)
...
def load_data():
    # Excel 파일 읽기
    df = pd.read_excel("e:/DSHI RPA/STREAMLIT/PKG3_data.xlsx")
